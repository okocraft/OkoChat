...
public sealed interface MemberStatus permits MemberStatus.Banned, MemberStatus.Member, MemberStatus.Muted, MemberStatus.NoStatus {
    ...
    sealed interface Member extends MemberStatus permits Moderator, NormalMember {
    ...
    sealed interface NormalMember extends Member permits MutedMember, MemberStatusImpl.NormalMember {
    ...
    sealed interface Moderator extends Member permits Administrator, MemberStatusImpl.Moderator {
    ...
    sealed interface Administrator extends Moderator permits MemberStatusImpl.Administrator {
    ...
    sealed interface MutedMember extends NormalMember, Muted permits MemberStatusImpl.MutedMember {
