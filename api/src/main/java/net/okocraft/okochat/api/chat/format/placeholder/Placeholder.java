...
public interface Placeholder<C extends ChatContext> {
    ...
    RegistryKey<String, Placeholder<ChannelChatContext>> REGISTRY_FOR_PRIVATE_CHAT = RegistryKey.create(Key.key("okochat:chat/placeholder/private_chat"));

    static <C extends ChatContext> @NotNull Placeholder<C> string(@NotNull String value) {
        return new Placeholders.StringPlaceholder<>(value);
    }
