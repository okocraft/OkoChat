...
public class ChannelMemberBungeeConsole extends ChannelMemberBungee {
     ...
     * 発言者にメッセージを送信する
     * @param message メッセージ
     * @see ChannelMember#sendMessage(java.lang.String)
     */
    @Override
     ...
     * @see ChannelMember#sendMessage(net.md_5.bungee.api.chat.BaseComponent[])
     */
     ...
     * @return 権限を持っているかどうか
     * @see ChannelMember#hasPermission(java.lang.String)
     */
    @Override
     ...
     * @param node パーミッションノード
     * @return 定義を持っているかどうか
     * @see ChannelMember#isPermissionSet(java.lang.String)
     */
    @Override
     ...
     * 指定されたメッセージの内容を発言する
     * @param message メッセージ
     * @see ChannelMember#chat(java.lang.String)
     */
