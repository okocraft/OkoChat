 ...
 */
package net.okocraft.okochat.core.bukkit;
...
public class BukkitEventSender implements EventSenderInterface {
     ...
     * @return イベント実行結果
     * @see com.github.ucchyocean.lc3.event.EventSenderInterface#sendLunaChatChannelChatEvent(String, com.github.ucchyocean.lc3.member.ChannelMember, String, String, String)
     */
    @Override
     ...
     * @param member 作成した人
     * @return イベント実行結果
     * @see com.github.ucchyocean.lc3.event.EventSenderInterface#sendLunaChatChannelCreateEvent(String, com.github.ucchyocean.lc3.member.ChannelMember)
     */
    @Override
     ...
     * @return イベント実行結果
     * @see com.github.ucchyocean.lc3.event.EventSenderInterface#sendLunaChatChannelMemberChangedEvent(String, List, List)
     */
    @Override
     ...
     * @return イベント実行結果
     * @see com.github.ucchyocean.lc3.event.EventSenderInterface#sendLunaChatChannelMessageEvent(String, com.github.ucchyocean.lc3.member.ChannelMember, String, ArrayList, String, String)
     */
    @Override
     ...
     * @return イベント実行結果
     * @see com.github.ucchyocean.lc3.event.EventSenderInterface#sendLunaChatChannelOptionChangedEvent(String, com.github.ucchyocean.lc3.member.ChannelMember, HashMap)
     */
    @Override
     ...
     * @return イベント実行結果
     * @see com.github.ucchyocean.lc3.event.EventSenderInterface#sendLunaChatChannelRemoveEvent(String, com.github.ucchyocean.lc3.member.ChannelMember)
     */
    @Override
     ...
     * @return イベント実行結果
     * @see com.github.ucchyocean.lc3.event.EventSenderInterface#sendLunaChatPostJapanizeEvent(String, com.github.ucchyocean.lc3.member.ChannelMember, String, String)
     */
    @Override
     ...
     * @param message 発言内容
     * @return イベント実行結果
     * @see com.github.ucchyocean.lc3.event.EventSenderInterface#sendLunaChatPreChatEvent(String, com.github.ucchyocean.lc3.member.ChannelMember, String)
     */
    @Override
