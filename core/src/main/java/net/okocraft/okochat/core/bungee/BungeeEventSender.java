...
public class BungeeEventSender implements EventSenderInterface {
     ...
     * @return イベント実行結果
     * @see com.github.ucchyocean.lc3.event.EventSenderInterface#sendLunaChatChannelMessageEvent(String, com.github.ucchyocean.lc3.member.ChannelMember, String, java.util.ArrayList, String, String)
     */
    @Override
     ...
     * @return イベント実行結果
     * @see com.github.ucchyocean.lc3.event.EventSenderInterface#sendLunaChatChannelOptionChangedEvent(String, com.github.ucchyocean.lc3.member.ChannelMember, java.util.HashMap)
     */
    @Override
